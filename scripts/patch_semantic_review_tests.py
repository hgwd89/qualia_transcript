...
def patch_test() -> None:
    ...
    replace_exact(
        ...
        '            from services.processing_jobs import execute_job\n            from scripts.audit_production_readiness_v2 import JOB_SCOPE_RULES\n',
    )
    replace_exact(
        path,
